...
int wg = 55 ;  // hard 60.  // easy 45
int wr = 14 ; //didtance between roobot and wall after line when red cube 
...
void wall(int wa) {
  ...
  if (distancer > wa + 1 && distancer < wa + 12) {  //
    frontlright();
...
void blue(int wl , char A , char B) {
