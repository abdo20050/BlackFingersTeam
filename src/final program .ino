...
if(result.ID >= 13 && result.ID <= 18 && on4 == 1)
{
wall();
  on3=1;
on4 = 0 ;
...
if(result.ID >= 13 && result.ID <= 18 && on4 == 1 && result.ID >= 1 && result.ID <=6)
{
wall();
  on3=1;
on4 = 0 ;
...
if(result.ID >= 20 && result.ID <= 24  && distancef<=120 && on3 == 1){
  front();
  delay(1900);
  fronthleft();
  delay(600);
